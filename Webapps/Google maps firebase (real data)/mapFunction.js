// counter for online trashbins_count...
...
// This Function will create a trashbin icon  and add/display that marker on the map
function AddTrashBin(data) {
    var icon = { // trashbin icon
        ...
        scale: 2,
        fillColor: "#ED3D17", //<--Color, you can change it 
        fillOpacity: 1,
        strokeWeight: 1,
        anchor: new google.maps.Point(0, 5),
        //rotation: data.val().Percentage //<-- angle
    };
    var posisi = { lat: data.val().Latitude, lng: data.val().Longitude };
    var contentString =  data.val().FillLevel + "%"
...
// this event will be triggered on location change of any tarshbin...
