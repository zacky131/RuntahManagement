package com.resikin.percakapan.ui.login.activities;
...
import static com.resikin.percakapan.ui.ChatUI.BUNDLE_SIGNED_UP_USER_EMAIL;
import static com.resikin.percakapan.ui.ChatUI.BUNDLE_SIGNED_UP_USER_PASSWORD;
...
public class ChatSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.resikin.percakapan.R.layout.activity_chat_signup);

        // get Firebase auth instance
        mAuth = FirebaseAuth.getInstance();

        toolbar = findViewById(com.resikin.percakapan.R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(false);

        progressBar = findViewById(com.resikin.percakapan.R.id.progress_bar);

        inputEmail = findViewById(com.resikin.percakapan.R.id.email);
        inputFirstName = findViewById(com.resikin.percakapan.R.id.first_name);
        inputLastName = findViewById(com.resikin.percakapan.R.id.last_name);
        inputPassword = findViewById(com.resikin.percakapan.R.id.password);
        inputRepeatPassword = findViewById(com.resikin.percakapan.R.id.repeat_password);

        btnSignup = findViewById(com.resikin.percakapan.R.id.signup);
                ...
                if (isValidEmail && areValidPasswords) {
                    createUserOnFirebaseAuthentication(email, password, new OnUserCreatedOnFirebaseCallback() {
                        ...
                        public void onUserCreatedSuccess(final String userUID) {
                            ...
                            createUserOnContacts(userUID, userMap, new OnUserCreatedOnContactsCallback() {
                                ...
                                public void onUserCreatedError(Exception e) {
                                    // TODO: 04/01/18
                                    Toast.makeText(com.resikin.percakapan.ui.login.activities.ChatSignUpActivity.this, "Saving user on contacts failed." + e,
                        ...
                        public void onUserCreatedError(Exception e) {
                            ...
                            Toast.makeText(com.resikin.percakapan.ui.login.activities.ChatSignUpActivity.this, "Authentication failed." + e,
                                    Toast.LENGTH_SHORT).show();
                        }
                    });
                }
    ...
    private boolean validateEmail(String email) {
        if (!StringUtils.isValid(email) || (StringUtils.isValid(email) && !StringUtils.validateEmail(email))) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_email_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    ...
    private boolean validateFirstName(String firstName) {
        if (!StringUtils.isValid(firstName)) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_first_name_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    ...
    private boolean validateLastName(String lastName) {
        if (!StringUtils.isValid(lastName)) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_last_name_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    ...
    private boolean validatePassword(String password, String repeatedPassword) {
        if (!StringUtils.isValid(password)) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_password_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (password.length() < MIN_PASSWORD_LENGTH) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_password_length_label, MIN_PASSWORD_LENGTH),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (!StringUtils.isValid(repeatedPassword)) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_repeated_password_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (repeatedPassword.length() < MIN_PASSWORD_LENGTH) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_not_valid_repeated_password_length_label, MIN_PASSWORD_LENGTH),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (!password.equals(repeatedPassword)) {
            Toast.makeText(getApplicationContext(),
                    getString(com.resikin.percakapan.R.string.chat_signup_activity_passwords_mismatch_label),
                    Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void createUserOnFirebaseAuthentication(final String email,
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(com.resikin.percakapan.ui.login.activities.ChatSignUpActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
