...
public class MessageListAdapter extends AbstractRecyclerAdapter<Message, RecyclerView.ViewHolder> {
    ...
    private static final String TAG = com.resikin.percakapan.ui.messages.adapters.MessageListAdapter.class.getName();
...
//        Log.d(TAG, "position: " + position);
        ...
        if (sender.compareTo(loggedUser.getId()) == 0) {
            viewType = com.resikin.percakapan.R.id.row_sender;
            ...
            viewType = com.resikin.percakapan.R.id.row_system;
        } else {
            viewType = com.resikin.percakapan.R.id.row_recipient;
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == com.resikin.percakapan.R.id.row_sender) {
            return new SenderViewHolder(
                    inflater.inflate(com.resikin.percakapan.R.layout.row_sender, parent, false));
        } else if (viewType == com.resikin.percakapan.R.id.row_recipient) {
            return new RecipientViewHolder(
                    inflater.inflate(com.resikin.percakapan.R.layout.row_recipient, parent, false));
        } else if (viewType == com.resikin.percakapan.R.id.row_system) {
            return new SystemViewHolder(
                    inflater.inflate(com.resikin.percakapan.R.layout.row_system, parent, false));
        }
        return null;
    }
