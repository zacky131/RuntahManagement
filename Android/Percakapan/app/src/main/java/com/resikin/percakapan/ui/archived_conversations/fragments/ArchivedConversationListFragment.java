...
import com.resikin.percakapan.ui.archived_conversations.adapters.ArchivedConversationsListAdapter;
...
public class ArchivedConversationListFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.resikin.percakapan.R.layout.fragment_archived_conversation_list, container, false);
...
//                getResources().getDrawable(R.drawable.decorator_fragment_conversation_list)));
        recyclerViewConversations.addItemDecoration(new ItemDecoration(getContext(),
                ...
                getResources().getDrawable(com.resikin.percakapan.R.drawable.decorator_fragment_archived_conversation_list)));
