package com.resikin.percakapan.ui.messages.activities;
...
import com.resikin.percakapan.core.messages.handlers.ConversationMessagesHandler;
import com.resikin.percakapan.core.messages.listeners.ConversationMessagesListener;
import com.resikin.percakapan.core.messages.listeners.SendMessageListener;
...
import com.resikin.percakapan.storage.OnUploadedCallback;
import com.resikin.percakapan.storage.StorageHandler;
import com.resikin.percakapan.ui.ChatUI;
import com.resikin.percakapan.ui.chat_groups.activities.GroupAdminPanelActivity;
import com.resikin.percakapan.ui.messages.adapters.MessageListAdapter;
import com.resikin.percakapan.ui.messages.fragments.BottomSheetAttach;
import com.resikin.percakapan.ui.messages.listeners.OnMessageClickListener;
...
import static com.resikin.percakapan.utils.DebugConstants.DEBUG_NOTIFICATION;
...
public class MessageListActivity extends AppCompatActivity
    ...
    private static final String TAG = com.resikin.percakapan.ui.messages.activities.MessageListActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.resikin.percakapan.R.layout.activity_message_list);
...
//        }
    ...
    private void registerViews() {
        ...
        recyclerView = (RecyclerView) findViewById(com.resikin.percakapan.R.id.main_activity_recycler_view);
        toolbar = (Toolbar) findViewById(com.resikin.percakapan.R.id.toolbar);
        mPictureView = (ImageView) findViewById(com.resikin.percakapan.R.id.toolbar_picture);
        mTitleTextView = (TextView) findViewById(com.resikin.percakapan.R.id.toolbar_title);
        mSubTitleTextView = (TextView) findViewById(com.resikin.percakapan.R.id.toolbar_subtitle);

        mNoMessageLayout = (RelativeLayout) findViewById(com.resikin.percakapan.R.id.no_messages_layout);

        editText = (EmojiEditText) findViewById(com.resikin.percakapan.R.id.main_activity_chat_bottom_message_edittext);
        rootView = (ViewGroup) findViewById(com.resikin.percakapan.R.id.main_activity_root_view);
        emojiButton = (ImageView) findViewById(com.resikin.percakapan.R.id.main_activity_emoji);
        attachButton = (ImageView) findViewById(com.resikin.percakapan.R.id.main_activity_attach);
        sendButton = (ImageView) findViewById(com.resikin.percakapan.R.id.main_activity_send);
        recyclerView = (RecyclerView) findViewById(com.resikin.percakapan.R.id.main_activity_recycler_view);
        mEmojiBar = (LinearLayout) findViewById(com.resikin.percakapan.R.id.main_activity_emoji_bar);
    }

    private void initDirectToolbar(final IChatUser recipient) {
        // toolbar picture
        setPicture(recipient.getProfilePictureUrl(), com.resikin.percakapan.R.drawable.ic_person_avatar);
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(com.resikin.percakapan.ui.messages.activities.MessageListActivity.this,
    ...
    private void initGroupToolbar(final ChatGroup chatGroup) {
        // toolbar picture
        setPicture(chatGroup.getIconURL(), com.resikin.percakapan.R.drawable.ic_group_avatar);
        ...
        if (chatGroup != null && chatGroup.getMembersList() != null &&
            ...
            groupMembers = getString(com.resikin.percakapan.R.string.activity_message_list_group_info_you_label);
        }
    ...
    private void initInputPanel() {
        ...
        emojiButton.setColorFilter(ContextCompat
                .getColor(this, com.resikin.percakapan.R.color.emoji_icons), PorterDuff.Mode.SRC_IN);
                        ...
                        text, channelType, null, new SendMessageListener() {
                            ...
                            public void onBeforeMessageSent(Message message, ChatRuntimeException chatException) {
                                if (chatException == null) {
                                    ...
                                    Toast.makeText(com.resikin.percakapan.ui.messages.activities.MessageListActivity.this,
...
////    }
    ...
    private void showConfirmUploadDialog(
        ...
        new AlertDialog.Builder(this)
                .setTitle(getString(com.resikin.percakapan.R.string.activity_message_list_confirm_dialog_upload_title_label))
                .setMessage(getString(com.resikin.percakapan.R.string.activity_message_list_confirm_dialog_upload_message_label))
    ...
    private void uploadFile(File file) {
        ...
        // bugfix Issue #45
        final ProgressDialog progressDialog = new ProgressDialog(com.resikin.percakapan.ui.messages.activities.MessageListActivity.this);
        progressDialog.setMessage(getString(com.resikin.percakapan.R.string.activity_message_list_progress_dialog_upload));
...
//                                metadata.put("uid", uid);
                                ...
                                if (type.toLowerCase().equals(StorageHandler.Type.Image.toString().toLowerCase())) {
                                    lastMessageText = getString(com.resikin.percakapan.R.string.activity_message_list_type_image_label);
                                } else if (type.equals(StorageHandler.Type.File)) {
                                    lastMessageText = getString(com.resikin.percakapan.R.string.activity_message_list_type_file_label);
                                }
            ...
            public void onUploadFailed(Exception e) {
                ...
                Toast.makeText(com.resikin.percakapan.ui.messages.activities.MessageListActivity.this,
                        getString(com.resikin.percakapan.R.string.activity_message_list_progress_dialog_upload_failed),
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        emojiPopup = EmojiPopup.Builder.fromRootView(rootView)
                ...
                .setOnEmojiPopupShownListener(new OnEmojiPopupShownListener() {
                    ...
                    public void onEmojiPopupShown() {
                        emojiButton.setImageResource(com.resikin.percakapan.R.drawable.ic_keyboard_24dp);
                    }
                })
...
//                })
                ...
                .setOnEmojiPopupDismissListener(new OnEmojiPopupDismissListener() {
                    @Override
                    public void onEmojiPopupDismiss() {
                        emojiButton.setImageResource(com.resikin.percakapan.R.drawable.emoji_ios_category_people);
                    }
                })
    ...
    public void isUserOnline(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            mSubTitleTextView.setText(getString(com.resikin.percakapan.R.string.activity_message_list_convers_with_presence_online));
        } else {
            ...
            if (conversWithLastOnline != PresenceHandler.LAST_ONLINE_UNDEFINED) {
                ...
                mSubTitleTextView.setText(getString(com.resikin.percakapan.R.string.activity_message_list_convers_with_presence_offline));
            }
        }
    }
