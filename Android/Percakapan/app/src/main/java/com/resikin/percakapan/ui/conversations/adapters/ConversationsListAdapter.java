package com.resikin.percakapan.ui.conversations.adapters;
...
public class ConversationsListAdapter extends AbstractRecyclerAdapter<Conversation,
        com.resikin.percakapan.ui.conversations.adapters.ConversationsListAdapter.ViewHolder> {
    private static final String TAG = com.resikin.percakapan.ui.conversations.adapters.ConversationsListAdapter.class.getName();
    ...
    @Override
    public com.resikin.percakapan.ui.conversations.adapters.ConversationsListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.resikin.percakapan.R.layout.row_conversation, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(com.resikin.percakapan.ui.conversations.adapters.ConversationsListAdapter.ViewHolder holder, final int position) {
    ...
    private void setGroupSenderName(ViewHolder holder, Conversation conversation) {
        if (conversation.isGroupChannel()) {
            ...
            if (conversation.getSender() != null && conversation.getSender()
                ...
                sender = holder.itemView.getContext().getString(com.resikin.percakapan.R.string.activity_conversation_list_adapter_you_label);
            } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            recipientPicture = itemView.findViewById(com.resikin.percakapan.R.id.recipient_picture);
            recipientDisplayName = itemView.findViewById(com.resikin.percakapan.R.id.recipient_display_name);
            senderDisplayName = itemView.findViewById(com.resikin.percakapan.R.id.sender_display_name);
            lastTextMessage = itemView.findViewById(com.resikin.percakapan.R.id.last_text_message);
            lastMessageTimestamp = itemView.findViewById(com.resikin.percakapan.R.id.last_message_timestamp);

            close = itemView.findViewById(com.resikin.percakapan.R.id.close);
            unread = itemView.findViewById(com.resikin.percakapan.R.id.unread);

            swipeItem = itemView.findViewById(com.resikin.percakapan.R.id.swipe_item);
...
//            swipeItem.addDrag(SwipeLayout.DragEdge.Left, swipeItem.findViewById(R.id.swipe_left));
            swipeItem.addDrag(SwipeLayout.DragEdge.Right, swipeItem.findViewById(com.resikin.percakapan.R.id.swipe_right));
        }
    }
}