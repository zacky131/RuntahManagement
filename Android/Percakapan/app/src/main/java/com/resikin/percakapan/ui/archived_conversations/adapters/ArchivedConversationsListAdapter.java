package com.resikin.percakapan.ui.archived_conversations.adapters;
...
import com.resikin.percakapan.ui.archived_conversations.listeners.OnSwipeMenuReopenClickListener;
...
public class ArchivedConversationsListAdapter extends AbstractRecyclerAdapter<Conversation,
    ...
    public ArchivedConversationsListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.resikin.percakapan.R.layout.row_archived_conversation, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            reopen = itemView.findViewById(com.resikin.percakapan.R.id.reopen);
