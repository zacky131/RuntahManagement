package com.resikin.percakapan.core;
...
import com.resikin.percakapan.core.authentication.ChatAuthentication;
import com.resikin.percakapan.core.chat_groups.syncronizers.GroupsSyncronizer;
import com.resikin.percakapan.core.contacts.listeners.OnContactCreatedCallback;
...
import com.resikin.percakapan.utils.IOUtils;
...
public class ChatManager {
    private static final String TAG = com.resikin.percakapan.core.ChatManager.class.getName();
    ...
    private static com.resikin.percakapan.core.ChatManager mInstance;
...
//        Log.v(TAG, "ChatManager.getloggedUser");
    ...
    public void createContactFor(String uid, String email,
        ...
        if (StringUtils.isValid(com.resikin.percakapan.core.ChatManager.Configuration.firebaseUrl)) {
            contactsNode = FirebaseDatabase.getInstance()
                    .getReferenceFromUrl(com.resikin.percakapan.core.ChatManager.Configuration.firebaseUrl)
                    .child("/apps/" + com.resikin.percakapan.core.ChatManager.Configuration.appId + "/contacts");
        } else {
            contactsNode = FirebaseDatabase.getInstance()
                    .getReference()
                    .child("/apps/" + com.resikin.percakapan.core.ChatManager.Configuration.appId + "/contacts");
    ...
    public static void start(Context context, String appId, IChatUser currentUser) {
        ...
        com.resikin.percakapan.core.ChatManager.Configuration mChatConfiguration =
                new com.resikin.percakapan.core.ChatManager.Configuration.Builder(appId).build();
...
//        MultiDex.install(context);
        ...
        // create a new chat
        com.resikin.percakapan.core.ChatManager chat = new com.resikin.percakapan.core.ChatManager(); // create the instance of the chat
...
//    }
    ...
    private void deleteInstanceId() {
        ...
        // remove the instanceId for the logged user
        DatabaseReference firebaseUsersPath = root
                .child("apps/" + com.resikin.percakapan.core.ChatManager.Configuration.appId + "/users/" +
     ...
     * @return the instance
     */
    public static com.resikin.percakapan.core.ChatManager getInstance() {
