package com.resikin.percakapan.core.messages.handlers;
...
public class ConversationMessagesHandler {
    private static final String TAG = com.resikin.percakapan.core.messages.handlers.ConversationMessagesHandler.class.getName();
