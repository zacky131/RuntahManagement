...
import com.resikin.percakapan.utils.views.TouchImageView;
...
public class ImageDetailsActivity extends AppCompatActivity {
    private static final String TAG = com.resikin.percakapan.ui.messages.activities.ImageDetailsActivity.class.getName();
...
//    private FloatingActionButton mBtnDownload;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.resikin.percakapan.R.layout.activity_image_details);
        ...
        if (StringUtils.isValid(title)) {
            TextView mTitle = findViewById(com.resikin.percakapan.R.id.image_title);
        ...
        if (StringUtils.isValid(sender)) {
            TextView mSender = findViewById(com.resikin.percakapan.R.id.sender);
            mSender.setText(sender);
        }
        // ### end sender

        // ### begin timestamp
        TextView mTimestamp = findViewById(com.resikin.percakapan.R.id.timestamp);
        try {
...
//    };
    ...
    private void setImage(String imgUrl) {
        ...
        final TouchImageView mImage = findViewById(com.resikin.percakapan.R.id.image);
