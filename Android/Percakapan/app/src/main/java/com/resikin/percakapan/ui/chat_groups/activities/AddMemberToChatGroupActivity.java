...
import com.resikin.percakapan.ui.chat_groups.WizardNewGroup;
import com.resikin.percakapan.ui.chat_groups.activities.NewGroupActivity;
import com.resikin.percakapan.ui.chat_groups.adapters.SelectedContactListAdapter;
...
public class AddMemberToChatGroupActivity extends AppCompatActivity implements OnContactClickListener, OnRemoveClickListener {
    ...
    private static final String TAG = com.resikin.percakapan.ui.chat_groups.activities.AddMemberToChatGroupActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.resikin.percakapan.R.layout.activity_add_member_to_chat_group);

        selectedList = new ArrayList<>();
        cvSelectedContacts = findViewById(com.resikin.percakapan.R.id.cardview_selected_contacts);
        rvSelectedList = findViewById(com.resikin.percakapan.R.id.selected_list);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.resikin.percakapan.R.menu.menu_activity_add_members, menu);

        actionNextMenuItem = menu.findItem(com.resikin.percakapan.R.id.action_next);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            onBackPressed();
            return true;
        } else if (item.getItemId() == com.resikin.percakapan.R.id.action_next) {
            onActionNextClicked();
            return true;
        }
...
//            contactsListAdapter.removeFromAlreadyAddedList(contact);
            ...
            Snackbar.make(findViewById(com.resikin.percakapan.R.id.coordinator),
                    getString(com.resikin.percakapan.R.string.add_members_activity_contact_not_added_label),
