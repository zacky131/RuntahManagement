package com.resikin.percakapan.ui.conversations.fragments;
...
import com.resikin.percakapan.core.conversations.ConversationsHandler;
...
import com.resikin.percakapan.core.presence.MyPresenceHandler;
import com.resikin.percakapan.core.presence.listeners.MyPresenceListener;
...
import com.resikin.percakapan.ui.archived_conversations.activities.ArchivedConversationListActivity;
import com.resikin.percakapan.ui.chat_groups.activities.ChatGroupsListActivity;
import com.resikin.percakapan.ui.conversations.adapters.ConversationsListAdapter;
import com.resikin.percakapan.ui.conversations.fragments.BottomSheetConversationsListFragmentLongPress;
import com.resikin.percakapan.ui.conversations.listeners.OnConversationClickListener;
import com.resikin.percakapan.ui.conversations.listeners.OnConversationLongClickListener;
import com.resikin.percakapan.ui.conversations.listeners.OnSwipeMenuCloseClickListener;
import com.resikin.percakapan.ui.conversations.listeners.OnSwipeMenuUnreadClickListener;
...
import com.resikin.percakapan.utils.http_manager.HttpManager;
import com.resikin.percakapan.utils.http_manager.OnResponseRetrievedCallback;

import java.util.HashMap;
import java.util.Map;

import static com.resikin.percakapan.utils.DebugConstants.DEBUG_MY_PRESENCE;
...
public class ConversationListFragment extends Fragment implements
    ...
    private static final String TAG = com.resikin.percakapan.ui.conversations.fragments.ConversationListFragment.class.getName();
...
//    };
    ...
    public static Fragment newInstance() {
        Fragment mFragment = new com.resikin.percakapan.ui.conversations.fragments.ConversationListFragment();
        return mFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.resikin.percakapan.R.layout.fragment_conversation_list, container, false);
        setHasOptionsMenu(true);


        // init RecyclerView
        recyclerViewConversations = view.findViewById(com.resikin.percakapan.R.id.conversations_list);
...
//                getResources().getDrawable(R.drawable.decorator_fragment_conversation_list)));
        recyclerViewConversations.addItemDecoration(new ItemDecoration(getContext(),
                ...
                getResources().getDrawable(com.resikin.percakapan.R.drawable.decorator_fragment_conversation_list)));
        ...
        // no conversations layout
        noConversationsLayout = view.findViewById(com.resikin.percakapan.R.id.layout_no_conversations);
        toggleNoConversationLayoutVisibility(conversationsListAdapter.getItemCount());

        // add new conversations button
        addNewConversation = (FloatingActionButton) view.findViewById(com.resikin.percakapan.R.id.button_new_conversation);
        setAddNewConversationClickBehaviour();

        currentUserGroups = view.findViewById(com.resikin.percakapan.R.id.groups);
        subheader = view.findViewById(com.resikin.percakapan.R.id.subheader);
...
//                ChatManager.getInstance().getLoggedUser().getId(), onMyPresenceListener);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.resikin.percakapan.R.menu.menu_fragment_conversations_list, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
       ...
       if(itemId == com.resikin.percakapan.R.id.action_archived) {
...
//        Log.i(TAG, "onSwipeMenuUnread: conversation: " + conversation.toString() + " position: " + position);
    ...
    private void deleteConversation(final String conversationId, Map<String, String> headerParams) {
        ...
        String url = getString(com.resikin.percakapan.R.string.chat_firebase_cloud_functions_url) +
    ...
    private void closeSupportGroup(final String groupId, Map<String, String> headerParams) {
        ...
        String url = getString(com.resikin.percakapan.R.string.chat_firebase_cloud_functions_url) + "/supportapi/" +
