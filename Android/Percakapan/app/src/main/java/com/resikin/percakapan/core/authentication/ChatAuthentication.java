package com.resikin.percakapan.core.authentication;
...
import com.resikin.percakapan.core.authentication.task.GetCustomTokenTask;
import com.resikin.percakapan.core.authentication.task.OnCustomAuthTokenCallback;
...
import com.resikin.percakapan.instanceid.receiver.TokenBroadcastReceiver;
import com.resikin.percakapan.utils.ChatUtils;
...
//    https://github.com/firebase/quickstart-android/blob/master/auth/app/src/main/java/com/google/firebase/quickstart/auth/CustomAuthActivity.java
    ...
    private static com.resikin.percakapan.core.authentication.ChatAuthentication authInstance;
...
// Prevent form the reflection api.
    ...
    public void signInWithUid(final Activity loginActivity, final String appId,
        ...
        String generateTokenUrl = loginActivity
                .getString(com.resikin.percakapan.R.string.custom_auth_verify_token_url) + userIdNormalized;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    // fix Issue #5
                    String userId = com.resikin.percakapan.core.authentication.ChatAuthentication.getInstance()
                            .getFirebaseAuth()
                            .getCurrentUser()
                            .getUid();
...
//                };
    ...
    public static com.resikin.percakapan.core.authentication.ChatAuthentication getInstance() {
        Log.d(DEBUG_LOGIN, "getInstance");

        if (authInstance == null) {
            authInstance = new com.resikin.percakapan.core.authentication.ChatAuthentication();
