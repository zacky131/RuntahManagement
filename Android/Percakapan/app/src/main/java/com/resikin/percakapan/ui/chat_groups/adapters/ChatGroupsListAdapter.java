 ...
 */
public class ChatGroupsListAdapter extends AbstractRecyclerAdapter<ChatGroup, com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder> {
    ...
    @Override
    public com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.resikin.percakapan.R.layout.row_group, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder holder, final int position) {
...
//        setCreatedOn(holder, chatGroup.getCreatedOnLong());
    ...
    private void setName(com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder holder, String name) {
...
//    }
    ...
    private void setImage(com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder holder, String imageUrl) {
    ...
    private void setMembers(com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder holder, ChatGroup chatGroup) {
        ...
        if (chatGroup.getMembersList() != null && chatGroup.getMembersList().size() > 0) {
            ...
            members = holder.itemView.getContext().getString(com.resikin.percakapan.R.string.activity_message_list_group_info_you_label);
        }
    ...
    private void setOnGroupClickListener(
            com.resikin.percakapan.ui.chat_groups.adapters.ChatGroupsListAdapter.ViewHolder holder,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            name = (TextView) itemView.findViewById(com.resikin.percakapan.R.id.recipient_display_name);
//            createdOn = (TextView) itemView.findViewById(R.id.created_on);
            image = (ImageView) itemView.findViewById(com.resikin.percakapan.R.id.recipient_picture);
            members = (TextView) itemView.findViewById(com.resikin.percakapan.R.id.members);
        }
    }
}