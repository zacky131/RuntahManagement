...
public class GroupMembersListAdapter extends AbstractRecyclerAdapter<IChatUser,
        com.resikin.percakapan.ui.chat_groups.adapters.GroupMembersListAdapter.ViewHolder> {
    ...
    @Override
    public com.resikin.percakapan.ui.chat_groups.adapters.GroupMembersListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//        Log.d(TAG, "onCreateViewHolder");
        View view = LayoutInflater.from(parent.getContext())
                .inflate(com.resikin.percakapan.R.layout.row_group_members, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(com.resikin.percakapan.ui.chat_groups.adapters.GroupMembersListAdapter.ViewHolder holder, final int position) {
...
//        Log.d(TAG, "loadProfileImage");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            contact = (TextView) itemView.findViewById(com.resikin.percakapan.R.id.recipient_display_name);
            profilePicture = (ImageView) itemView.findViewById(com.resikin.percakapan.R.id.recipient_picture);
            mGroupAdminLabel = (TextView) itemView.findViewById(com.resikin.percakapan.R.id.label_admin);
        }
    }
}