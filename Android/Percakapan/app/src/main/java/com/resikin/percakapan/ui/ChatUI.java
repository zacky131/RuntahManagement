package com.resikin.percakapan.ui;
...
import com.resikin.percakapan.ui.contacts.listeners.OnCreateGroupClickListener;
import com.resikin.percakapan.ui.conversations.activities.ConversationListActivity;
...
import com.resikin.percakapan.ui.messages.listeners.OnAttachClickListener;
...
public class ChatUI implements Serializable {
    ...
    private static final String TAG = com.resikin.percakapan.ui.ChatUI.class.getName();
    ...
    private static volatile com.resikin.percakapan.ui.ChatUI instance;
    ...
    public static com.resikin.percakapan.ui.ChatUI getInstance() {
        if (instance == null) { //if there is no instance available... create new one
            synchronized (com.resikin.percakapan.ui.ChatUI.class) {
                if (instance == null) instance = new com.resikin.percakapan.ui.ChatUI();
            }
        }
...
//            }
    ...
    private void startMessageListActivity(IChatUser contact, String channel) {
        ...
        intent.putExtra(com.resikin.percakapan.ui.ChatUI.BUNDLE_RECIPIENT, contact);
