package com.resikin.percakapan.core.messages.models;
...
public class Message implements Serializable, Cloneable {
    private static final String TAG = com.resikin.percakapan.core.messages.models.Message.class.getName();
    ...
    public boolean isDirectChannel() {
        if (this.channelType == null || this.channelType.equals(com.resikin.percakapan.core.messages.models.Message.DIRECT_CHANNEL_TYPE)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean isGroupChannel() {
        if (this.channelType != null && this.channelType.equals(com.resikin.percakapan.core.messages.models.Message.GROUP_CHANNEL_TYPE)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean equals(Object object) {
        if (object instanceof com.resikin.percakapan.core.messages.models.Message) {
            com.resikin.percakapan.core.messages.models.Message message = (com.resikin.percakapan.core.messages.models.Message) object;
