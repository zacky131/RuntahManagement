package com.resikin.percakapan.ui.chat_groups;
...
//            "PRIVATE_NEW_GROUP_WIZARD_SERIALIZABLE_CHAT_GROUP";
    ...
    private static volatile com.resikin.percakapan.ui.chat_groups.WizardNewGroup instance;
    ...
    public static com.resikin.percakapan.ui.chat_groups.WizardNewGroup getInstance() {
        if (instance == null) { //if there is no instance available... create new one
            synchronized (com.resikin.percakapan.ui.chat_groups.WizardNewGroup.class) {
                if (instance == null) instance = new com.resikin.percakapan.ui.chat_groups.WizardNewGroup();
            }
        }
