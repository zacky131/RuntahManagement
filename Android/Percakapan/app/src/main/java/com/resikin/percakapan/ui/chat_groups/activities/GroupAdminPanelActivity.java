...
import com.resikin.percakapan.ui.chat_groups.adapters.GroupMembersListAdapter;
import com.resikin.percakapan.ui.chat_groups.fragments.BottomSheetGroupAdminPanelMember;
import com.resikin.percakapan.ui.chat_groups.listeners.OnGroupMemberClickListener;
...
import static com.resikin.percakapan.ui.ChatUI.BUNDLE_CHAT_GROUP;
import static com.resikin.percakapan.ui.ChatUI.BUNDLE_GROUP_ID;
...
public class GroupAdminPanelActivity extends AppCompatActivity implements
    ...
    private static final String TAG = com.resikin.percakapan.ui.chat_groups.activities.GroupAdminPanelActivity.class.getName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.resikin.percakapan.R.layout.activity_group_admin_panel);
        registerViews();
    ...
    private void registerViews() {
        ...
        mMemberList = (RecyclerView) findViewById(com.resikin.percakapan.R.id.members);
        mGroupImage = (ImageView) findViewById(com.resikin.percakapan.R.id.image);
        mBoxAddMember = (LinearLayout) findViewById(com.resikin.percakapan.R.id.box_add_member);
        mBoxMembers = (LinearLayout) findViewById(com.resikin.percakapan.R.id.box_members);
        mBoxUnavailableMembers = (LinearLayout) findViewById(com.resikin.percakapan.R.id.box_unavailable_members);
    }
    ...
    private void setToolbar() {
        ...
        // chatGroup name
        TextView toolbarTitle = findViewById(com.resikin.percakapan.R.id.toolbar_title);
...
//        toolbarSubTitle.setText("");
    ...
    private void setCreatedBy() {
        ...
        TextView createdByView = (TextView) findViewById(com.resikin.percakapan.R.id.created_by);
...
//        String createdBy = getString(R.string.activity_group_admin_panel_formatted_created_by_label, creator);
    ...
    private void setCreatedOn() {
        TextView createdOnView = (TextView) findViewById(com.resikin.percakapan.R.id.created_on);
...
//        String createOn = getString(R.string.activity_group_admin_panel_formatted_created_on_label, timestamp);
    ...
    private void setGroupId() {
        TextView groupIdView = findViewById(com.resikin.percakapan.R.id.group_id);
//        String groupId = getString(R.string.activity_group_admin_panel_formatted_group_id_label, chatGroup.getGroupId());
    ...
    private void initRecyclerViewMembers() {
        ...
        mMemberList.addItemDecoration(new ItemDecoration(this,
                ...
                getResources().getDrawable(com.resikin.percakapan.R.drawable.decorator_activity_group_admin_panel_members_list)));
            ...
            public void onClick(View view) {
                ...
                if (AbstractNetworkReceiver.isConnected(getApplicationContext())) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            getString(com.resikin.percakapan.R.string.menu_activity_group_admin_panel_activity_cannot_add_member_offline),
